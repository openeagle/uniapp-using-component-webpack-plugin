...
class UniappUsingComponentsWebpackPlugin {
  constructor(options = {}) {
    // 验证 options 是否符合规范
    validate(schema, options, {
      name: 'UniappUsingComponentsWebpackPlugin',
    })
  ...
  apply(compiler) {
    compiler.hooks.thisCompilation.tap(
      'UniappUsingComponentsWebpackPlugin',
      (compilation) => {
        // 添加资源 hooks
    ...
    compiler.hooks.afterEmit.tap('UniappUsingComponentsWebpackPlugin', () => {
...
module.exports = UniappUsingComponentsWebpackPlugin
